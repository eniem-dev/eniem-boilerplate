...
Create a functional specification through adaptive interview by asking the user structured questions.

## Usage

Invoke this skill with a feature name: `functional-spec <feature-name>`
...
**Question framing:**
- Provide clear options when choices exist
...
- Present all unresolved items grouped by section
